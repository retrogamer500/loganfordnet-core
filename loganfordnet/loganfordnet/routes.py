from .views.user.userview import user_page_factory, user_model_factory
from .views.pagemaintenance.pagemaintenanceview import page_maintenance_page_factory, page_maintenance_model_factory
